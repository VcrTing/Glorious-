...
import com.glorious.system.backend.service.impl.CustomerServiceImpl;
...
@RestController
@RequestMapping(CustomerWebDefine.API)
public class CustomerController {
    ...
    @Admin
    @PostMapping
    public AjaxResult pos(@RequestBody CustomerForm form) {
    ...
    public AjaxResult upd(@PathVariable Long id, @RequestBody CustomerForm form) {
